        ...
        <form action="{{ route('subjects.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-3">
                <a href="{{ route('subjects.index') }}"
                    class="px-5 py-3 bg-gray-300 dark:bg-gray-600 text-gray-800 dark:text-gray-100 rounded-md
                           hover:bg-gray-400 dark:hover:bg-gray-500 transition text-center text-lg">
                    Cancel
                </a>

                <button type="submit"
                    class="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-3 rounded-md shadow text-center text-lg">
                    Save Subject
                </button>
            </div>
        </form>
