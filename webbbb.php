...
public function sendReceiptWhatsapp($studentId)
{
    ...
    if ($payments->isEmpty()) {
        return redirect()->back()->with('warning', '⚠️ No fee payments found for this student.');
    }
    ...
    // Truehost public directory (SAME PATTERN AS RESULT)
    ...
    // Parent phone (international format — SAME AS RESULT)
    $parentPhone = preg_replace('/^0/', '234', $student->guardian->phone);
